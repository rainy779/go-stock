export namespace data {
	...
	export class SettingConfig {
	    ...
	    tgPushEnable: boolean;
	    tgBotToken: string;
	    tgChatId: string;
	    tgAiConfigId: number;
	    tgSysPromptId: number;
	    tgUserPrompt: string;
	    tgUseProxy: boolean;
	    aiConfigs: AIConfig[];
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.tgPushEnable = source["tgPushEnable"];
	        this.tgBotToken = source["tgBotToken"];
	        this.tgChatId = source["tgChatId"];
	        this.tgAiConfigId = source["tgAiConfigId"];
	        this.tgSysPromptId = source["tgSysPromptId"];
	        this.tgUserPrompt = source["tgUserPrompt"];
	        this.tgUseProxy = source["tgUseProxy"];
	...
	export class UplimitAISummary {
	    ...
	    static createFrom(source: any = {}) {
	        return new UplimitAISummary(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.id = source["id"];
	        this.createdAt = this.convertValues(source["createdAt"], null);
	        this.analyzeDate = source["analyzeDate"];
	        this.analyzeTime = source["analyzeTime"];
	        this.modelName = source["modelName"];
